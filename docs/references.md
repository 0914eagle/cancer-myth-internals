...
- Misconceptions in Multi-Turn Medical Conversations — [2607.12884](https://arxiv.org/abs/2607.12884)
- Safer in Translation? Presupposition Robustness in Indic Languages — [2511.01360](https://arxiv.org/abs/2511.01360)
- How RLHF Amplifies Sycophancy — [2602.01002](https://arxiv.org/abs/2602.01002)
- MedPRESS — [2608.02520](https://arxiv.org/html/2608.02520)
...
- AO 보정 — [2605.26045](https://arxiv.org/html/2605.26045)
- LatentQA — [2412.08686](https://arxiv.org/html/2412.08686v1) (ICLR 2026)
- Do Activation Verbalization Methods Convey Privileged Information? — [2509.13316](https://arxiv.org/html/2509.13316) (ICML 2026)
- Learning Self-Interpretation from Interpretability Artifacts — ICML 2026 (OpenReview TrugNgxtey)
- Patchscopes — [2401.06102](https://arxiv.org/abs/2401.06102)
...
## Negative bias
- Correcting Negative Bias via Negative Attention Score Alignment (NAS/NASA) — [2408.00137](https://arxiv.org/abs/2408.00137) · NAACL 2025
- Multifaceted Analysis of Negative Bias — [2511.10881](https://arxiv.org/abs/2511.10881)

## 의료 + 해석가능성
- Can SAEs reveal and mitigate racial biases of LLMs in healthcare? — [2511.00177](https://arxiv.org/abs/2511.00177) · [GitHub](https://github.com/hibaahsan/sae_bias) (ICLR 2026)
- Medical Interpretability and Knowledge Maps — OpenReview BhqFWlYKUi (ICLR 2026)

## SAE 스위트
- Gemma Scope (Gemma-2)
- Llama Scope — [2410.20526](https://arxiv.org/abs/2410.20526) · [fnlp/Llama-Scope](https://huggingface.co/fnlp/Llama-Scope)
- Qwen-Scope — [2605.11887](https://arxiv.org/abs/2605.11887) · [Qwen/SAE-Res-Qwen3-8B-Base-W64K-L0_100](https://huggingface.co/Qwen/SAE-Res-Qwen3-8B-Base-W64K-L0_100)

## 탈락 후보 (기록용)
- MedREK — [2510.13500](https://arxiv.org/abs/2510.13500) · 저장소 `mylittleriver/MedREK` **존재하지 않음**
