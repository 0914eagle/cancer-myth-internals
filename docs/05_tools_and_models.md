...
| Well-Actually Well | [ShenranTomWang/Well](https://github.com/ShenranTomWang/Well) — FPQ/TPQ 분할, 6개 방법군, GEPA·FAITH·LoRA 스크립트, evaluator 8종. 지원 계열 `llama3.2, qwen2.5, qwen3, gemma4, llama3, olmo3` |
