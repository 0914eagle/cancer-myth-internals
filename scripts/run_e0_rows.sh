...
# E0: question table + activation rows. CPU + OpenAI (span alignment). Once.
#
...
python scripts/make_rows.py --config configs/default.yaml --out-name "${ROWS_NAME}" --align "${ALIGN}"
